package com.obj.nc.binder;

import com.obj.nc.binder.config.FileMessageBinderConfiguration;
import com.obj.nc.binder.producers.FileMessageProducer;
...
@SpringJUnitConfig(FileMessageBinderConfiguration.class)
