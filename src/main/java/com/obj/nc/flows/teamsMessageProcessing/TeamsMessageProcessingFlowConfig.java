...
public class TeamsMessageProcessingFlowConfig {
    ...
    public MessageChannel sendInputChannel() {
        return channelFactory.getPublishSubscribeChannel(TEAMS_PROCESSING_FLOW_INPUT_CHANNEL_ID);
    }

    @Bean(TEAMS_PROCESSING_FLOW_OUTPUT_CHANNEL_ID)
    public MessageChannel sendOutputChannel() {
        return channelFactory.getPublishSubscribeChannel(TEAMS_PROCESSING_FLOW_OUTPUT_CHANNEL_ID);
    }
