...
public class TestDataRestController {
    ...
    private void saveEndpoint(RecievingEndpoint endpoint, String timeString) {
    ...
    private void persistNotificationIntent() {
        ...
        intent.getHeader().addEventId(UUID.fromString("e2c59478-6032-4bde-a8c1-0ce42248484d"));
    ...
    private void persistMessages() {
        // Email 1
        MessagePersistantState message = new MessagePersistantState();
        message.setHeader(new Header());
        message.setId(UUID.fromString("5f74929b-2635-4515-9f30-ba79e200e92b"));
        message.getHeader().setFlowId("default-flow");
        message.getHeader().addEventId(UUID.fromString("e2c59478-6032-4bde-a8c1-0ce42248484d"));
        ...
        // Email 2
        message = new MessagePersistantState();
        message.setHeader(new Header());
