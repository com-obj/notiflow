...
@Disabled
class MailchimpMailchimpAggregatedContentMapperImplTest {
...
//    @Autowired
//    @Qualifier(MailchimpAggregatedContentMapper.COMPONENT_NAME)
//    private MailchimpAggregatedContentMapper mapper;
