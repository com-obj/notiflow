...
class KoderiaEventConverterProcessorFunctionTest {

    @Autowired
    private KoderiaEventConverterProcessorFunction koderiaEventConverter;
    ...
    void testConvertJobPostDto() {
        ...
        // when
        NotificationIntent mappedNotificationIntent = koderiaEventConverter.apply(emitEventDto);
